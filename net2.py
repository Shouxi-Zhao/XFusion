...
class MultiFocusTransNet(nn.Module):
    def __init__(self, n_channels = 3, n_classes=1, bilinear=True, **args):
        ...
        self.down1 = Down(64, 128)              # 1 480 640
        self.down2 = Down(128, 256)             # 1 240 320 
        self.down3 = Down(256, 512)             # 1 120 160
        self.down4 = Down(512, 512)             # 1 60 80 - > 30 40
        ...
        self.transencoder = nn.Sequential(
            ...
            RearrangeTensor('b c (h w) -> b c h w', c=512, h=30, w=40),
        )
